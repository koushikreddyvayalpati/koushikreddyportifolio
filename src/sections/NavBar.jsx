...
const Navbar = () => {
  ...
  return (
    <section className="c-space my-20">
      <header className="fixed top-0 left-0 right-0 z-30 bg-black/90 shadow-md shadow-gray-600">
        <div className="w-full items-start sm:w-[100%] mx-0">
          <div className="flex justify-between items-center py-1 px-0 sm:px-10 pb-0 ">
          <a
    href="/"
  ...
  >
    Vayalpati Koushik Reddy
            ...
            <button
              onClick={toggleMenu}
              className="text-neutral-400 hover:text-white focus:outline-none sm:hidden flex px-1"
              aria-label="Toggle menu"
            >
              <img
                src={isOpen ? 'menucross.png' : 'menuo1.png'}
                alt="toggle"
                className="w-6 h-6"
              />
            </button>
